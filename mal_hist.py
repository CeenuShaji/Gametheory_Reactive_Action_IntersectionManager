...
X_id=['x1', 'x2', 'x3','x4','x5','x6','x7','x8','x9','x10','x11','x12','x13','x14','xEm2','xEm4']
x1=[]
x2=[]
x3=[]
x4=[]
...
xEm2=[]
xEm4=[]
Y_time = [x1, x2, x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,xEm2,xEm4]
characters_after_x=[]
# Extract array names
...
def generate_fixed_imposter_ID():
    ...
    vehID2=Vehicle('emergency1', 'south', 'west', 'C', current_timestamp, '')
    ...
    vehID6=Vehicle('emergency5', 'west', 'east', 'C', current_timestamp,'')
    vehID7=Vehicle(6, 'west', 'east', 'A', current_timestamp,'')
    vehID8=Vehicle(7, 'south', 'west', 'A', current_timestamp,'')
    vehID9=Vehicle(9, 'south', 'north', 'C', current_timestamp,'')
    vehIDEm2=Vehicle('emergency2', 'north', 'west', 'C', current_timestamp,'')
    vehID10=Vehicle(8, 'south', 'east', 'A', current_timestamp,'')
    vehID11=Vehicle(9, 'south', 'north', 'B', current_timestamp,'')
    vehID12=Vehicle('emergency3', 'west', 'north', 'C', current_timestamp,'')
    vehID13=Vehicle(10, 'east', 'west', 'B', current_timestamp,'')
    vehID14=Vehicle(11, 'east', 'west', 'A', current_timestamp,'')
    vehID15=Vehicle(12, 'east', 'west', 'B', current_timestamp,'')
...
def generate_fixed_ID(): # Em2 and 4 are the only real EV
    ...
    vehID8=Vehicle(7, 'south', 'west', 'A', current_timestamp,'')
    vehID9=Vehicle(9, 'south', 'west', 'C', current_timestamp,'')
